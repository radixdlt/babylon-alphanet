...
API_SCHEMA_LOCATION = '../../gateway-api-v0-schema.yaml'
API_GENERATED_DESTINATION = '../generated'
...
if __name__ == "__main__":
    ...
    api_schema_temp_filename = os.path.join(OPENAPI_TEMP_GENERATION_FOLDER, 'gateway-api-v0-schema.yaml')
